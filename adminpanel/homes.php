...
{
$sql=mysql_query("UPDATE `tbl_cms` SET `name` = '".$_REQUEST['txt_title']."', page_title = '', `content` = '".$_POST['FCKeditor1']."' WHERE `tbl_cms`.`id` =1");
?>
<script>window.location="homes.php?status=success";</script>
<?
}
?>
...
<head>
  ...
  <title>Stark Information - Admin - Home</title>
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <div class="column1-unit">
		  ...
		  <p align="center" style="color: #FF0000"><strong>Home Content Updates Successfully</strong></p>
		  <? }
...
$description='';
$count=0;
$result = mysql_query("SELECT * FROM tbl_cms where id=1");
