...
{
$sql=mysql_query("UPDATE `tbl_cms` SET `name` = '".$_REQUEST['txt_title']."', page_title = '', `content` = '".$_POST['FCKeditor1']."' WHERE `tbl_cms`.`id` =3");
?>
<script>window.location="contact.php?status=success";</script>
<?
}
?>
...
<head>
  ...
  <title>Stark Information - Admin - Contact us</title>
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <div class="column1-unit">
		  ...
		  <p align="center" style="color: #FF0000"><strong>Contact us Content Updates Successfully</strong></p>
		  <? }
...
$description='';
$count=0;
$result = mysql_query("SELECT * FROM tbl_cms where id=3");
