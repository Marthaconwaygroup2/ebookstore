<?
$_COOKIE['chk_id']='';
if($_REQUEST['sess']!='failed') { 
if($_COOKIE['chk_id']=='') { ?>
<script> document.cookie="chk_id=" +escape(<?php echo time(); ?>); </script>
<? }
}
...
<head>
  ...
  <title>Stark Information - Index</title>
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <div class="column1-unit">
          ...
          <? if($_REQUEST['sess']=='failed') { ?><p align="center" style="color:#FF0000;"><strong>Session Timeout. Please Buy Again</strong></p><? } ?>
		  <p><? echo $content; ?></p>
